...
class Generator(nn.Module):
    ...
    def forward(self, x):
        # Ensure the input tensor has the desired shape
...
def get_model_and_optimizer(latent_size, encoded_num, hidden_size):
    ...
    #discrim_optim = optim.SGD(discriminator.parameters(), lr=0.00003, momentum = 0.9)
    discrim_optim = optim.Adam(discriminator.parameters(), lr=0.00001, betas=(0, 0.9))
    gen_optim = optim.Adam(generator.parameters(), lr=0.00001, betas=(0, 0.9))
